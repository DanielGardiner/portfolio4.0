  ...
  return (
    ...
    >
      <div className="">
        ...
        <button class="mt-6 inline-flex items-center rounded bg-[#5DC1C2] py-2 px-4 font-bold text-black hover:bg-[#7AF9F2]">
      ...
      <div className="flex items-center justify-center relative">
        ...
        >
          {/* <div className="absolute top-[-90px] right-[-500px]  z-[10] h-[100%] w-[100%] rounded-full bg-gradient-to-r from-[#72F3EF] to-[#D53449] opacity-[25%] blur-[180px]" /> */}
          <Image
            src={MobileImg}
            width="auto"
            height="auto"
